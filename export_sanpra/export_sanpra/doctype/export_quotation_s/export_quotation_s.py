...
class ExportQuotations(Document):
	...
	def all_calculations(self):
		...
		#Changes by Karpe Sir 29/07/2026
		...
		# 	* linear_currency
		# ) / 100
		# self.cnf_ocean_freight = cnf_ocan_total + ocean_freight    
		#Changes by Karpe Sir 29/07/2026
		
		#Changes by Karpe Sir 07/08/2026

		no_of_fcl = frappe.utils.flt(self.no_of_fcl)
		ocean_freight_doller = frappe.utils.flt(self.ocean_frieght_fcl_doller)
		
		cnf_ocan_total = (ocean_freight_doller * no_of_fcl * conversion_rate) * linear_currency / 100
		self.cnf_ocean_freight = (ocean_freight_doller * no_of_fcl * conversion_rate) + cnf_ocan_total
